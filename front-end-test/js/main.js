...
// Địa chỉ backEnd
const backEndUrl = 'https://localhost:8401';
//const backEndUrl = 'https://sbelcom.tk:8444';
//const backEndUrl = 'https://103.21.151.185:8444';
...
function uploadSingleFile(file) {
    ...
    if(myKeyJwt) {
        ...
        xhr.open("POST", backEndUrl + '/uploadFile');
